        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <label><input name="gender" value="male" data-parsley-multiple="gender" type="radio"> &nbsp; Male &nbsp;</label>
                        <label> <input name="gender" value="female" data-parsley-multiple="gender" type="radio"> Female</label>
                    </div>
                </div>
