        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="row">
                    ...
                    <span class="col-md-12 text-center"><img src="<?php echo $this->themeUrl . 'image/image.jpg'; ?>" alt="<?php echo $productDetail['product_title']; ?>"></span>
                    <span class="col-md-8 col-md-offset-2  text-justify"><p><?php echo $productDetail['product_descp']; ?></p></span>
                </div>
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <span class="col-md-12 text-center"><h5><?php echo $leadForm[0]['form_title']; ?></h5></span>
                        <?php
