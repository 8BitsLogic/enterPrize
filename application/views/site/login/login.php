                            ...
                            <div class="ui--section-content container clearfix">
                                <div class="ui--animation-in make--fx--flipIn-X ui--pass clearfix" data-fx="fx--flipIn-X" data-delay="200" data-start-delay="0">
                                    <div class="ui-row row">
                                        ...
                                        <div class="ui-column span6"><div class="ui--icon-box position--top"><span class="ui--icon-box-icon ui--animation"><a href="<?php echo base_url(); ?>"><img src="<?php echo $this->themeUrl; ?>/images/logo.png" alt="img" class="img-responsive center-block"></a></span><div class="ui--icon-box-content"></div></div><h1 id="custom-title-h1-1" class="ui--animation " style="text-align: center; margin-bottom: 0px; "><strong>Welcome to BYOB Ltd</strong></h1><h4 id="custom-title-h4-1" class="ui--animation " style="text-align: center; ">LEARN, EARN , GROW</h4></div>
                                        <div class="ui-column span3"></div>
                                    </div>
