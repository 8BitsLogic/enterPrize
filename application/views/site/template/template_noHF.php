...
<html lang="en">
    ...
    <head>
        ...
        <link type="text/css" media="all" href="<?php echo $this->themeUrlSite; ?>/css/login.css" rel="stylesheet" />
        <!-- include the site stylesheet -->
        <link rel="stylesheet" href="<?php echo $this->themeUrlSite; ?>/css/bootstrap.css">
        <!-- include the site stylesheet -->
        <link rel="stylesheet" href="<?php echo $this->themeUrlSite; ?>/css/style.css">

        <!--<link rel="stylesheet" href="<?php echo $this->themeUrlSite; ?>/css/responsive.css">-->
         <!--include the site stylesheet--> 
        <!--<link rel="stylesheet" href="<?php echo $this->themeUrlSite; ?>/css/color.css">-->
