<p class="lead">Add Image Resource</p>
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="r_type" name="r_type" required="required" readonly="" class="form-control col-md-7 col-xs-12" type="text" value="image">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        <input id="r_link" required="" name="r_link" class="col-md-12 col-xs-12" type="file" accept=".jpg,.png" >
    </div>
</div>
